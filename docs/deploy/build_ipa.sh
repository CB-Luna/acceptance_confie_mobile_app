...
# Script para generar IPA de producción para Acceptance Insurance App
...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║                                                            ║"
echo "║         Acceptance Insurance - iOS IPA Builder                ║"
echo "║                                                            ║"
echo "╚════════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
IPA_PATH="$PROJECT_DIR/build/ios/ipa/Acceptance.ipa"
...
if [ -f "$IPA_PATH" ]; then
    ...
    echo "     - Ve a 'My Apps' > Acceptance Insurance"
