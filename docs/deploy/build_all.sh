...
# Script para generar AAB e IPA de producción para Acceptance Insurance App
...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║                                                            ║"
echo "║      Acceptance Insurance - Multi-Platform Builder           ║"
...
case $OPTION in
    ...
    3)
        ...
        echo -e "  🍎 iOS:     build/ios/ipa/Acceptance.ipa"
        echo ""
        ;;
    *)
